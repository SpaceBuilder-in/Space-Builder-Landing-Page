            ...
            <main className="w-full flex-1 flex flex-col relative pt-36 pb-20 px-6">
                ...
                <div className="relative mx-auto w-full max-w-[1300px] flex-1 flex flex-col justify-center">
                    ...
                    <div className="mx-auto max-w-2xl text-center mb-10">
                        ...
                        <h1 
                            className="font-display text-4xl font-semibold tracking-tight text-fg md:text-5xl leading-[1.1]"
                        >
                            Let's Build Something <span className="font-serif italic font-normal text-gold-2">Exceptional</span>
                        </h1>
                        <p className="mt-4 text-base text-fg-muted max-w-lg mx-auto">
                            Submit your contact details and message below. We will analyze your query and reach out to outline a customized automation strategy.
                        </p>
                    </div>
                            ...
                            {submitStatus?.success ? (
                                ...
                                <form onSubmit={handleSubmit} className="space-y-6 animate-fade-up">
                                    ...
                                    <div className="space-y-2">
                                        <label htmlFor="name" className="block text-xs uppercase tracking-[0.14em] text-fg-muted font-medium">
                                            Name
                                        </label>
                                        <input
                                            type="text"
                                    ...
                                    {/* Email */}
                                    <div className="space-y-2">
                                        <label htmlFor="email" className="block text-xs uppercase tracking-[0.14em] text-fg-muted font-medium">
                                            Email Address
                                        </label>
                                        <input
                                            type="email"
                                    ...
                                    {/* Mobile Number */}
                                    <div className="space-y-2">
                                        <label htmlFor="mobile" className="block text-xs uppercase tracking-[0.14em] text-fg-muted font-medium">
                                            Mobile Number
                                        </label>
                                        <input
                                            type="tel"
                                    ...
                                    {/* Message */}
                                    <div className="space-y-2">
                                        <label htmlFor="message" className="block text-xs uppercase tracking-[0.14em] text-fg-muted font-medium">
                                            Message / Query
                                        </label>
                                        <textarea
                                            id="message"
